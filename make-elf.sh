...
EI_ETYPE="\x03\x00";	# DYN (Shared object file) code 3 in little endian
EI_MACHINE="\x3e\x00";	# EM_X86_64 in little endian
EI_MACHINE_VERSION="\x01\x00\x00\x00" # 1 in little endian
EI_ENTRY="\x40\x00\x00\x00\x00\x00\x00\x00";	# TODO: program code entry point uint64_t
...
EI_EHSIZE="\x40\x00";	# TODO: elf header size in bytes
EI_PHENTSIZE="\x38\x00" # TODO: program header entry size (sizeof(Elf64_Phdr))
EI_PHNUM="\x01\x00"; 	# TODO number of program header entries
...
PH_FLAGS="\x00\x00\x00\x00"	# Elf64_Word p_flags 4;
PH_OFFSET="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Off p_offset 8;
PH_VADDR="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Addr p_vaddr 8;
PH_PADDR="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Addr p_paddr 8;
PH_FILESZ="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Xword p_filesz 8;
PH_MEMSZ="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Xword p_memsz 8;
PH_ALIGN="\x00\x00\x00\x00\x00\x00\x00\x00"	# Elf64_Xword p_align 8;
...
SECTION_ELF_DATA="${PROGRAM_HEADERS}${SECTION_HEADERS}";
